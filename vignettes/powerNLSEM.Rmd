...
```{r, results = "hide", warning=FALSE,error=F,message=F}
Result_Power <- powerNLSEM(model = model, POI = c("Y~X", "Y~Z", "Y~X:Z"), method = "sr",
                           ...
                           Ntotal = 2000, power_aim = .8, alpha = .05, CORES = 1, verbose = T,
                           seed = 2023)
```
