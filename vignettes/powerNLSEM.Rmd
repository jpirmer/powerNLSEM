...
If we choose `alpha_power_modeling = 1` within the smart search algorithm using `powerNLSEM`, then the sample sizes get optimized for that value. However, this is not adviced since in approx. half of the replications (retrials of the smart algorithm or brute algorithm) the sample size will actually be smaller than that resulting in the desired power rate.
