...
The package was created as a supplement to the publication **Irmer et al. (in press)** and its theory is based on Irmer et al. (2024). Here, a probit regression model with $\sqrt{n}$ as a predictor is fit to significance decisions for single parameters (using the $z$-test) within simulated data to describe the relationship between power and sample size $n$ (Irmer et al., 2024).
...
Irmer, J. P., Klein, A. G., & Schermelleh-Engel, K. (2024). A General Model-Implied Simulation-Based Power Estimation Method for Correctly and Misspecfied Models: Applications to Nonlinear and Linear Structural Equation Models. [Submitted for Publication] <https://doi.org/10.31219/osf.io/pe5bj>

Irmer, J. P., Klein, A. G., & Schermelleh-Engel, K. (in press). Estimating Power in Complex Nonlinear Structural Equation Modeling Including Moderation Effects: The `powerNLSEM R`-Package. _Behavior Research Methods._ 
