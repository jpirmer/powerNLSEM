...
#' @references Marsh, H. W., Wen, Z. & Hau, K. T. (2004). Structural equation models of latent interactions: Evaluation of alternative estimation strategies and indicator construction. Psychological Methods, 9(3), 275–300. <https://doi.org/10.1037/1082-989X.9.3.275>
#' @import stats
#' @import utils
#' @export
